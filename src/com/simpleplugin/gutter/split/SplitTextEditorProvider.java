...
public abstract class SplitTextEditorProvider implements AsyncFileEditorProvider, DumbAware {
  ...
  public SplitTextEditorProvider(@NotNull FileEditorProvider firstProvider) {
    ...
    myEditorTypeId = "split-provider[" + myFirstProvider.getEditorTypeId() + ";" + "]";
  }
  ...
  public Builder createEditorAsync(@NotNull final Project project, @NotNull final VirtualFile file) {
    ...
    return new Builder() {
      ...
      public FileEditor build() {
        return createSplitEditor(firstBuilder.build());
      }
    };
  }
  ...
  protected abstract FileEditor createSplitEditor(@NotNull FileEditor firstEditor);
